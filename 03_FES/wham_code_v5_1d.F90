...
integer :: rank, gleng1_min,gleng1_max,ngrid
...
! gleng2=nint((grid(2,2)-grid(1,2))/grid(3,2))+1
 ...
 !stop
  ...
  scf_loop : do
       ...
       if((cnvg.lt.toler).or.(iter.ge.50000))then
...
!performs wham scf.
implicit none
integer:: i_s1, i_s2, i_umbr, nbin1, umbr_n,ncv
integer:: nmax(umbr_n) 
